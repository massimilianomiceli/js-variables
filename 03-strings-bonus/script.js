...
// bonusssssssss scrivo una parola al contrario alternando caratteri maiuscoli e minuscoli

const parolaDaInvertire='Massimiliano';
let parolaInvertita='';

parolaDaInvertire.toLowerCase;

for (let i = 0; i <= parolaDaInvertire.length; i++) {
    if (i % 2 == 0) {
        parolaInvertita = parolaInvertita + parolaDaInvertire.charAt(parolaDaInvertire.length - i).toUpperCase();
    } else {
        parolaInvertita = parolaInvertita + parolaDaInvertire.charAt(parolaDaInvertire.length - i);
    }
}
